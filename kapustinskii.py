def kapustinskii(number_of_ions, cation_charge_number, anion_charge_number, cation_radius, anion_radius):
    ...
    :param number_of_ions:
    :param cation_charge_number:
    :param anion_charge_number:
    :param cation_radius:
    :param anion_radius:
    :return:
    '''
    lattice_energy = 1.079 * 10 ** 5 * cation_charge_number * anion_charge_number * number_of_ions / (
                cation_radius + anion_radius)
